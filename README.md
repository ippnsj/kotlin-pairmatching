...
```kotlin
enum class Course (private val name: String) {
    BACKEND("백엔드"),
    FRONTEND("프론트엔드");
...
```kotlin
enum class Level (private val name: String) {
    LEVEL1("레벨1"),
    LEVEL2("레벨2"),
    LEVEL3("레벨3"),
    LEVEL4("레벨4"),
...
- 미션은 [kotlin-pairmatching](https://github.com/ippnsj/kotlin-pairmatching) 저장소를 Fork/Clone해 시작한다.
- **기능을 구현하기 전에 kotlin-pairmatching/docs/README.md 파일에 구현할 기능 목록을 정리**해 추가한다.
